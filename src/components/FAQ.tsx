...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "В среднем от замера до установки проходит 3–4 недели. Точный срок зависит от сложности проекта и выбранных материалов. Мы всегда называем реальные сроки и соблюдаем договорённости.",
  },
  {
